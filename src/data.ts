...
const dmzDroneEscalationMessages: TacticalMessage[] = [
  ...
  },
  {
    ...
    classification: "hostile",
    payload: "정찰 드론 대응 국면 이후 북측 전투기 100대 출격. 파란 감시선 북측 근처에서 집단 항적 KPA-FTR-100 형성 후 남하 시작",
  ...
  },
  {
    ...
    trackHint: "KPA-FTR-100",
    classification: "hostile",
    payload: "북측 전투기 wave 남하. 집단 편대가 파란 감시선을 넘어 주황 대응선으로 접근",
    provenance: ["osint-natural-earth", "osint-ourairports", "synthetic-rf-node"],
    entityType: "FIGHTER_RAID",
    side: "RED",
    threatClassId: "RED_FIGHTER_RAID",
  ...
  },
  {
    ...
    trackHint: "KPA-FTR-100",
    classification: "hostile",
    payload: "북측 전투기 wave 주황 대응선 통과. RED WAR 북측으로 접근하며 편대 폭이 확장됨",
    provenance: ["osint-natural-earth", "osint-ourairports", "synthetic-rf-node"],
    entityType: "FIGHTER_RAID",
    side: "RED",
    threatClassId: "RED_FIGHTER_RAID",
